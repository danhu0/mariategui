...
Modified by Daniel Hu for Brown HIST1381
...
class live_FFT2():
    ...
    def __init__(self, **kwargs):
        ...
        if self.use_camera == False:
            # No camera!
            self.im = rgb2gray(img_as_float32(io.imread('José_Carlos_Mariátegui_in_1929.jpg'))) # One of our intrepid TAs (Yuanning was one of our HTAs for Spring 2019)
        else:
            # We found a camera!
        ...
        self.imJack = rgb2gray(img_as_float32(io.imread('José_Carlos_Mariátegui_in_1929.jpg'))) # Another one of our intrepid TAs (Jack was one of our TAs for Spring 2017)
    ...
    def camimage_ft(self):
        ...
        '''        
        This code reads an image from your webcam.
